...
class TransactionItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets balance_after
     *
     * @param int $balance_after Баланс после выполнения операции.
     *
     * @return self
     */
     ...
     * Sets balance_before
     *
     * @param int $balance_before Баланс до выполнения операции.
     *
     * @return self
     */
     ...
     * Sets profile_id
     *
     * @param int|null $profile_id Идентификатор профиля Релая. Для новых профилей это 12-символьная hex-строка.
     *
     * @return self
     */
