...
/**
 * MaxMessageTranscriptionResponseBody Class Doc Comment
 *
 * @category Class
 ...
 */
class MaxMessageTranscriptionResponseBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MaxMessageTranscriptionResponseBody';
    ...
    */
     ...
     * Sets media_id
     *
     * @param string $media_id Идентификатор записи или внешнего ресурса.
     *
     * @return self
     */
     ...
     * Sets transcription
     *
     * @param string|null $transcription Значение поля `transcription`.
     *
     * @return self
     */
