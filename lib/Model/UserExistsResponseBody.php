...
/**
 * UserExistsResponseBody Class Doc Comment
 *
 * @category Class
 * @package  Relaya\Sdk
 * @author   OpenAPI Generator team
 ...
 */
class UserExistsResponseBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UserExistsResponseBody';
    ...
    */
     ...
     * Sets exists
     *
     * @param bool $exists Indicates whether a user with the specified email exists
     *
     * @return self
     */
