...
/**
 * MaxChatSubscriptionResponseBody Class Doc Comment
 *
 * @category Class
 * @description Ответ на изменение подписки на обновления чата в MAX.
 * @package  Relaya\Sdk
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class MaxChatSubscriptionResponseBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MaxChatSubscriptionResponseBody';
    ...
    */
     ...
     * Sets subscribed
     *
     * @param bool $subscribed Показывает, активна ли подписка.
     *
     * @return self
     */
