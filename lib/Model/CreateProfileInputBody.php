...
class CreateProfileInputBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     *
     * @param string $integration_type Integration type (max, maxbot, telegrambot, telegram, vk, whatsapp)
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string|null $name Profile name (optional)
     *
     * @return self
     */
     ...
     * Sets plan_tier
     *
     * @param string|null $plan_tier Plan tier (paid, free)
     *
     * @return self
     */
