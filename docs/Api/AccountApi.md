...
| ------------- | ------------- | ------------- |
| [**getAccountModules()**](AccountApi.md#getAccountModules) | **GET** /account/modules | List account modules |
| [**getAccountModulesUsage()**](AccountApi.md#getAccountModulesUsage) | **GET** /account/modules/usage | Get account module usage |
| [**putAccountModulesModuleCode()**](AccountApi.md#putAccountModulesModuleCode) | **PUT** /account/modules/{moduleCode} | Update account module |
...
try {
    ...
    echo 'Exception when calling AccountApi->getAccountModulesUsage: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling AccountApi->putAccountModulesModuleCode: ', $e->getMessage(), PHP_EOL;
}
```
