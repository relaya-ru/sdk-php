...
**forward_chat_id** | **string** | Идентификатор чата, из которого нужно переслать сообщение. |
**forward_message_id** | **string** | Идентификатор сообщения, которое нужно переслать. |
