# # MaxResolveChatByPhoneResponseBody
...
**cached** | **bool** | Показывает, использовались ли локально сохраненные данные. |
...
**reachable** | **bool** | Показывает, можно ли написать адресату сразу после поиска. |
