...
**confirmed_at** | **\DateTime** | Время подтверждения операции в UTC. | [optional]
...
**provider** | **string** | Код внешнего провайдера. |
**provider_payment_id** | **string** | Идентификатор записи или внешнего ресурса. |
**status** | **string** | Текущий статус сущности. |
**topup_id** | **string** | Идентификатор записи или внешнего ресурса. |
**updated_at** | **\DateTime** | Время последнего обновления в UTC. |
